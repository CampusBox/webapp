    ...
    function eventsGridDirective() {
        return {
            ...
            template: ''+
                    ...
                    '<img style="height:{{width*10}}px !important; min-height: 200px; background: #aaa; width:auto;" ng-src="http://thapar.brinjal.in/superadmin/eventimg/{{event.eventId}}.jpg " class="md-card-image " alt="Washed Out ">' +
                    '<md-card-title>' +
                    '<md-card-title-text>' +
