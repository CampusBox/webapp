...
(function() {
        ...
        function AddCreativityController($scope, Upload, $sce, $timeout, $mdDialog, allDataService, tokenService, $state) {
            ...
            console.log(parseInt(localStorage.getItem('tutorial')));
                ...
                $scope.url = ""; $scope.media = {}; $scope.media.embedUrl = ""; $scope.media.mediaType = ""; $scope.linkPreview = {}; $scope.items = []; $scope.itemsMobile = [];
                ...
                $scope.readonly = false; $scope.removable = true; $scope.selectedItem = null; $scope.searchText = null; $scope.querySearch = querySearch; $scope.vegetables = loadVegetables(); $scope.tags = [];
                ...
                var numberChips = [];
                var numberChips2 = [];
                var numberBuffer = ''; $scope.autocompleteDemoRequireMatch = false; $scope.transformChip = transformChip;
