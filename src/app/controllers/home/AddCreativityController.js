        ...
        $scope.checkPublish = function() {
            if ($scope.isAllowed($scope.compulsaryP, $scope.creativity.type)) {
                ...
                if ($scope.isAllowed($scope.onlyText, $scope.creativity.type)) {
                    ...
                    $scope.publishable = $scope.textAdded && ($scope.websiteAdded || $scope.danceAdded || $scope.musicAdded);
                }
            } else {
                $scope.publishable = ($scope.websiteAdded || $scope.danceAdded || $scope.musicAdded);
            }
